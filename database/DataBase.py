...
class DataBase:
    def loadAccount(self):
        ...
        if user_data:
            ...
            self.player.brawlers_spg_unlock = brawlerData["brawlers_spg_unlock"]
    ...
    def createAccount(self):
        if os.path.exists("database/Player/plr.db"):
            ...
            var = (self.player.token, self.player.low_id, self.player.name, self.player.trophies, self.player.gold, self.player.gems, self.player.starpoints, self.player.tickets, self.player.Troproad, self.player.profile_icon, self.player.name_color, self.player.club_low_id, self.player.club_role, json.dumps({"highest_trophies": self.player.highest_trophies, "brawlersTrophies": self.player.brawlers_trophies, "UnlockedBrawlers": self.player.UnlockedBrawlers, "UnlockedSkins": self.player.UnlockedSkins, "brawlerPowerLevel": self.player.brawlerPowerLevel, "brawlerPoints": self.player.brawlerPoints, "brawlers_spg_unlock": self.player.brawlers_spg_unlock}), self.player.brawler_id, self.player.skin_id, self.player.room_id, self.player.box, self.player.bigbox, self.player.online, self.player.vip, self.player.player_experience, json.dumps([]), self.player.ccc, self.player.trioWINS, self.player.sdWINS, self.player.theme, self.player.BPTOKEN, self.player.BPXP, json_quests, jsonFBP, jsonBBP, self.player.notifRead, self.player.notifRead2)
