...
class BattleResultMessage(Writer):
    ...
    def encode(self):
        ...
        rank_values = {
            (0, 49): (20, 15, 10, 8, 6, 4, 0, 0, 0, 0),
            (50, 99): (20, 16, 12, 10, 8, 4, 0, 0, 0, 0),
            (100, 249): (20, 16, 12, 8, 6, 0, 0, -2, -3, -4),
            (250, 399): (20, 16, 10, 6, 0, -3, -3, -4, -4, -5),
            (400, 499): (20, 16, 8, 6, 0, -2, -3, -4, -5, -5),
            (500, 649): (20, 16, 6, 4, -2, -4, -5, -5, -5, -6),
            (650, 799): (20, 14, 4, 0, -3, -5, -6, -6, -6, -7),
            (800, 899): (18, 12, 2, -1, -4, -5, -6, -7, -7, -8),
            (900, 1099): (14, 10, -1, -3, -4, -5, -6, -7, -7, -8),
            (1100, 1249): (10, 8, -2, -4, -5, -6, -7, -7, -8, -9),
            (1250, 100000): (6, 2, -3, -5, -6, -7, -8, -9, -10, -11)
        }
        ...
        if set_double_trophies(True):
            print("Double trophies active, original:", tropGained)
            tropGained *= 2
            print("Trophies gained after applying double:", tropGained)
        else:
            tropGained *= 1
    
        if set_double_tokens(True):
            print("Double tokens active, original:", tokenGained)
            tokenGained *= 2
            print("Tokens gained after applying double:", tokenGained)
        else:
            tokenGained *= 1
        print("Final trophies to be added:", tropGained)
